   ...
   public class Order : DependencyObject
    {
        ...
        public static readonly DependencyProperty OrderDateProperty = DependencyProperty.Register("OrderDate", typeof(DateTime), typeof(Product), new UIPropertyMetadata(DateTime.MinValue));
        public OrderStatus? Status
        {
            get { return (OrderStatus?)GetValue(StatusProperty); }
            set { SetValue(StatusProperty, value); }
        }
        public static readonly DependencyProperty StatusProperty = DependencyProperty.Register("Status", typeof(OrderStatus?), typeof(Product), new UIPropertyMetadata(DateTime.MinValue));
        ...
        public static readonly DependencyProperty ShipDateProperty = DependencyProperty.Register("ShipDate", typeof(DateTime), typeof(Product), new UIPropertyMetadata(DateTime.MinValue));
        public DateTime DeiveryDate
        {
            get { return (DateTime)GetValue(DeiveryDateProperty); }
            set { SetValue(DeiveryDateProperty, value); }
        }
        public static readonly DependencyProperty DeiveryDateProperty = DependencyProperty.Register("DeiveryDate", typeof(DateTime), typeof(Product), new UIPropertyMetadata(DateTime.MinValue));
